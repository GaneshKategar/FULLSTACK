...
def vdform():
    ...
    try:
        ...
        return render_template('roomDetails.html',roomNumber='RoomNumber : '+roomNumber,name='Name : '+name,aadharNumber='Aadhar Number : '+aadharNumber,phoneNumber='Phone Number : '+phoneNumber)
    except:
